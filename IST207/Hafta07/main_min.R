...
################# EXAMPLE 1 #####################################################
################# AHMET ÖZTÜRK SAYFA 439 ÖRNEK 8.2 ##############################
#################################################################################

# ============================================================
# 1) Example data
# ============================================================
C <- matrix(c(45,17,21,30,
...
# ============================================================
lbl <- list(
  row_names = c("Merkez 1","Merkez 2","Dummy"),
  col_names = c("Garaj 1","Garaj 2","Garaj 3", "Garaj 4"),
  supply_label = "Arz",
  demand_label = "Talep",
...
################# EXAMPLE 2 #####################################################
################# AHMET ÖZTÜRK SAYFA 430 ÖRNEK 8.1 ##############################
#################################################################################
