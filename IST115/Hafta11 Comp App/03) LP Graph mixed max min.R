...
# ---------------------------
# Step 0) Choose objective type
# ---------------------------
# maximize <- TRUE   # TRUE = Maximize, FALSE = Minimize
maximize <- FALSE   # TRUE = Maximize, FALSE = Minimize
...
# Constraint senses per row of A
# sense <- c("<=", "<=", "<=")
sense <- c("<=", ">=", "<=")
...
# Feasibility check for mixed senses
...
# >>> NEW: choose min or max depending on objective type
